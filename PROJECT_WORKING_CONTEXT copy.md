...
1. A larger hero-flow redesign was attempted to create a more explicit ingress/core/egress story.
2. That version was rejected because it introduced visual issues and did not match the desired look.
...
9. Do not replace the hero flow with a radically different visualization unless the user explicitly approves that level of redesign.
10. Prefer small safe refinements to the hero: text sizing, spacing, packet positioning, readability, and subtle motion cleanup.
